...
def example_4_multiple_curves():
    ...
    cg_configs = [
        (
            "Light load (VCG=-0.15m)",
            CenterOfGravity(lcg=2.0, vcg=-0.15, tcg=0.0, total_mass=70.0, num_components=1),
        ),
        (
            "Medium load (VCG=-0.20m)",
            CenterOfGravity(lcg=2.0, vcg=-0.20, tcg=0.0, total_mass=80.0, num_components=1),
        ),
        (
            "Heavy load (VCG=-0.25m)",
            CenterOfGravity(lcg=2.0, vcg=-0.25, tcg=0.0, total_mass=90.0, num_components=1),
        ),
    ]
...
def example_9_stability_report():
    ...
    fig.suptitle(
        "Example 9: Comprehensive Stability Report", fontsize=16, fontweight="bold", y=0.995
    )

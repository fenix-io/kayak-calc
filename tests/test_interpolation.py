...
class TestInterpolateTransverse:
    ...
    def test_inconsistent_x_coordinates(self):
        ...
        points = [Point3D(0.0, -1.0, 0.0), Point3D(1.0, 1.0, 0.0)]  # Different x
    ...
    def test_unsorted_input_points(self):
        ...
        points = [Point3D(0.0, 1.0, 0.0), Point3D(0.0, -1.0, 0.0), Point3D(0.0, 0.0, 0.5)]
...
class TestInterpolateProfileTransverse:
    ...
    def test_profile_interpolation(self):
        ...
        points = [Point3D(2.0, -0.5, 0.1), Point3D(2.0, 0.5, 0.1)]
...
class TestInterpolateMultipleProfiles:
    ...
    def test_multiple_interpolations(self):
        ...
        profiles = [Profile(0.0, points1), Profile(2.0, points2), Profile(4.0, points3)]
...
class TestInterpolateToApex:
    ...
    def test_bow_interpolation(self):
        ...
        points = [Point3D(4.0, -0.5, 0.1), Point3D(4.0, 0.0, 0.0), Point3D(4.0, 0.5, 0.1)]
...
class TestCreateSymmetricProfile:
    ...
    def test_basic_symmetry(self):
        ...
        starboard_points = [Point3D(1.0, 0.0, 0.0), Point3D(1.0, 0.5, 0.1)]
    ...
    def test_centerline_inclusion(self):
        ...
        starboard_points = [Point3D(1.0, 0.2, 0.05), Point3D(1.0, 0.5, 0.1)]
    ...
    def test_negative_y_error(self):
        ...
        points = [Point3D(1.0, -0.5, 0.1), Point3D(1.0, 0.5, 0.1)]  # Negative y (port side)

...
def create_wedge_hull(length: float, width: float, depth: float, num_stations: int = 5) -> KayakHull:
...
class TestCalculateVolume:
    ...
    def test_volume_with_custom_stations(self):
        ...
        vol_10 = calculate_volume(hull, num_stations=10, use_existing_stations=False, method='trapezoidal')
        vol_20 = calculate_volume(hull, num_stations=20, use_existing_stations=False, method='trapezoidal')

...
from src.io.loaders import load_hull_from_json, load_hull_from_csv, save_hull_to_json, save_hull_to_csv
...
class TestEdgeCasesIntegration:
    ...
    def test_center_of_gravity_from_components(self):
        ...
        kayak = MassComponent(name="Kayak", mass=25.0, x=2.5, y=0.0, z=0.05, description="Kayak hull")
        paddler = MassComponent(name="Paddler", mass=75.0, x=2.5, y=0.0, z=0.3, description="Paddler")
...
class TestErrorHandling:
    ...
    def test_insufficient_profiles_for_stability(self):
        ...
        hull = KayakHull()
        hull.add_profile(Profile(station=0.0, points=[
            Point3D(0, -0.5, -0.5),
            Point3D(0, 0.5, -0.5),
            Point3D(0, 0.5, 0.1),
            Point3D(0, -0.5, 0.1)

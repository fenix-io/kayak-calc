...
class TestCenterOfBuoyancyDataclass:
    ...
    def test_initialization(self):
        ...
        cb = CenterOfBuoyancy(
            lcb=1.5, vcb=-0.2, tcb=0.0, volume=0.5, waterline_z=0.0, heel_angle=0.0
        )
    ...
    def test_repr(self):
        ...
        cb = CenterOfBuoyancy(lcb=1.0, vcb=-0.1, tcb=0.0, volume=0.3, waterline_z=0.0)
...
class TestCalculateCenterOfBuoyancy:
    ...
    def test_cb_convergence_with_stations(self):
        ...
        abs(cb_10.lcb - cb_5.lcb)
        abs(cb_20.lcb - cb_10.lcb)
...
class TestValidateCenterOfBuoyancy:
    ...
    def test_validate_non_finite_lcb(self):
        ...
        cb = CenterOfBuoyancy(lcb=np.nan, vcb=-0.2, tcb=0.0, volume=1.0, waterline_z=0.0)
    ...
    def test_validate_negative_volume(self):
        ...
        cb = CenterOfBuoyancy(lcb=1.0, vcb=-0.2, tcb=0.0, volume=-0.5, waterline_z=0.0)
    ...
    def test_validate_lcb_outside_hull(self):
        ...
        cb = CenterOfBuoyancy(
            lcb=5.0, vcb=-0.2, tcb=0.0, volume=1.0, waterline_z=0.0  # Hull is only 0-2m
        )
    ...
    def test_validate_vcb_above_waterline(self):
        ...
        cb = CenterOfBuoyancy(
            lcb=1.0, vcb=0.5, tcb=0.0, volume=1.0, waterline_z=0.0  # Above waterline at 0.0
        )
    ...
    def test_validate_extreme_heel_angle(self):
        ...
        cb = CenterOfBuoyancy(
            lcb=1.0, vcb=-0.2, tcb=0.0, volume=1.0, waterline_z=0.0, heel_angle=95.0
        )
    ...
    def test_validate_too_few_stations(self):
        ...
        cb = CenterOfBuoyancy(
            lcb=1.0, vcb=-0.2, tcb=0.0, volume=1.0, waterline_z=0.0, num_stations=1
        )

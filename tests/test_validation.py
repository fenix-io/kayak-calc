...
class TestCylindricalHullValidation:
    ...
    @pytest.mark.skip(reason="Circular profiles have ordering issues with get_submerged_points - see Task 8.1 notes")
    ...
    def test_cylinder_volume_convergence(self):
        ...
        for num_points in point_counts:
            hull = create_cylindrical_hull(
                ...
                radius=radius,
                num_stations=21,
                num_points_per_profile=num_points
            )

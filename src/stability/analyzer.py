...
class StabilityAnalyzer:
    ...
    def estimate_metacentric_height(self) -> Optional[float]:
        ...
        curve = self.generate_stability_curve(
            min_angle=0, max_angle=15, angle_step=1
        )
    ...
    def __repr__(self) -> str:
        ...
        return (
            ...
            f"  cg=CenterOfGravity(lcg={self.cg.lcg:.3f}, vcg={self.cg.vcg:.3f}, tcg={self.cg.tcg:.3f}),\n"
